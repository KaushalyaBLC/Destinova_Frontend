      ...
      >
        ...
        <div className="mb-3">
            <label className="form-label" htmlFor="achievements">
              Describe any notable academic achievements you attained after the age of 15 (e.g., awards, scholarships, high grades in specific subjects).
            </label>
            <textarea
          ...
          <div className="mb-3">
            <label className="form-label" htmlFor="codingExperience">
              Have you learned or practiced coding? If so, was it through school, self-learning, or projects?
            </label>
            <input
              type="text"
              className="form-control"
          ...
          <div className="mb-3">
            <label className="form-label" htmlFor="programmingLanguages">
              ...
              What programming languages have you tried, and what have you created?    (Keep empty if you have not tried coding yet)
            </label>
            <textarea
              className="form-control"
