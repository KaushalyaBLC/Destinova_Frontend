...
const NovaResultDisplay = ({ results }) => {
    ...
    <div className="col-lg-8 rounded">
      ...
      >
        <div className="p-5">
          {results && (
            <div>
              ...
              <h6 className="text-center pb-5">-Insights and Guidance by Nova, Your AI Career Counsellor-</h6>
              </div>
                    ...
                    <div className="bg-light p-3 rounded">
                      ...
                      {expandedEducation === index && (
                        <>
                          <div>
                            <h6>
                              Pathway to Higher Education in {education.name}
                            </h6>
                            <p>{education.path}</p>
                            <h6>Why This Path is Suitable for You?</h6>
                            <p>{education.whySuitable}</p>
                            <h6>How to Get Ready for {education.name} </h6>
                      ...
                      {expandedCareer === index && (
                        <>
                          <div>
                            ...
                            <h6>
                              How to Get Ready for a Career in {career.name}
                            </h6>
        ...
        <div className="p-3 d-flex flex-column justify-content-center align-items-center text-secondary">
          ...
          <img src={Logo} alt="" style={{ height: "5rem" }}></img>
          <div>
          <h6>Destinova</h6>
